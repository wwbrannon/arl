...
### skip-rewrite-form? {#skip-rewrite-form-p}

Check if a form should skip recur rewriting (quote, lambda, defmacro, loop).

**Signature:** `(skip-rewrite-form? head)`

---

### valid-binding-pair? {#valid-binding-pair-p}

Validate that a binding pair is a list of length 2.

**Signature:** `(valid-binding-pair? pair)`

---

### valid-bindings? {#valid-bindings-p}

Validate that bindings is a list of valid binding pairs.

**Signature:** `(valid-bindings? bindings)`

---

### rewrite-recur {#rewrite-recur}

Transform recur calls in an expression tree.

**Signature:** `(rewrite-recur expr vars recur-flag recur-vals)`

---

### generate-rebindings {#generate-rebindings}

Generate code to rebind loop variables from recur-vals list.

**Signature:** `(generate-rebindings vars recur-vals)`
