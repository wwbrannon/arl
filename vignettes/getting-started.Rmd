...
`let`, `do-list`, `->`, and `try` come from the prelude and need no import.

Non-prelude modules must be loaded explicitly with `import`:

```{arl, eval=FALSE}
(import math :refer :all)      ; inc/dec/abs/clamp/...
