...
variadic, comparisons chain, `=` is equality not assignment), and functions
from other R packages like `stats` and `utils` need an explicit `::` prefix
(e.g. `(stats::median (c 1 2 3))`). See
