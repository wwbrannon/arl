...
[known special forms](stdlib-reference.html#special-forms). Anything not in
...
- `define` / `set!` -- detect `(define name (lambda ...))` patterns and
  enable self-TCO when applicable
...
- `while`, `and`, `or` -- compiled to their R equivalents
