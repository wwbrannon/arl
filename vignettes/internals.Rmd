...
Rye environments, you will see names that start with `.__` (dot,
underscore, underscore). These are **reserved for Rye's internal
...
| Name | Purpose |
|------|---------|
| `.__env` | Reference to the enclosing Rye environment |
