...
When it encounters a call, it checks the operator against known special forms:
...
- `set!` -- mutation of existing bindings, with self-TCO detection for lambda assignments
