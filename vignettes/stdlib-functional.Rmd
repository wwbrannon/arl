...
(not #t)              ; => #f
(not #f)              ; => #t
(not 0)               ; => #f (0 is truthy in Rye)
(not #nil)            ; => #t
(not "hello")         ; => #f (non-#f values are truthy)
```

**Note:** In Rye (like Scheme), only `#f` is falsy. All other values including `0`, `""`, and `()` are truthy.
