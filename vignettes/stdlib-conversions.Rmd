...
**See also:** inexact->exact, exact? (in `math` module), inexact? (in `math` module)
...
**See also:** exact->inexact, exact? (in `math` module), inexact? (in `math` module)
...
**See also:** ->number, ->integer, exact->inexact
...
**See also:** ->number, ->double, make-rectangular (in `math` module)
