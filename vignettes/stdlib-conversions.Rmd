...
These functions are provided by the `conversions` module (`inst/arl/conversions.arl`).
...
**See also:** [inexact->exact](#inexact-to-exact), [exact?](stdlib-math.html#exact-p) (in `math` module), [inexact?](stdlib-math.html#inexact-p) (in `math` module)
...
**See also:** [exact->inexact](#exact-to-inexact), [exact?](stdlib-math.html#exact-p) (in `math` module), [inexact?](stdlib-math.html#inexact-p) (in `math` module)
