...
**Parameters:**
- **`obj`** — Object to get the S3 class of
...
**Parameters:**
- **`obj`** — First object
- **`rest`** — Additional objects to compare against
...
**Parameters:**
- **`generic-name`** — Symbol naming the generic function (e.g. 'equal?)
- **`class-name`** — Symbol naming the S3 class to dispatch on
- **`method-fun`** — Implementation function for this class
...
**Parameters:**
- **`generic-name`** — String naming the generic (e.g. "equal?")
- **`obj`** — Object whose class determines which method to call
...
**Parameters:**
- **`sym`** — Symbol to convert to string
...
**Parameters:**
- **`str`** — String to convert to symbol
...
**Parameters:**
- **`x`** — Exact (integer) number to convert to double
...
**Parameters:**
- **`x`** — Inexact (double) number to round to integer
...
## R-Style Numeric Conversions {#section-r-style-numeric-conversions}
...
**Parameters:**
- **`x`** — Value to convert to complex number
...
**Parameters:**
- **`x`** — Value to convert to atomic vector
