...
```{arl, include=FALSE}
(define __e1 (new.env :parent (emptyenv)))
(define __e2 (new.env :parent (emptyenv)))
(assign "x" 1 :envir __e1)
(assign "x" 1 :envir __e2)
(assert-true (equal?.environment __e1 __e2))
```
