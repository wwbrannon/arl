...
**Parameters:**
- **`args`** — Values to package together
...
**Parameters:**
- **`producer`** — Zero-argument function that returns values
- **`consumer`** — Function that receives the produced values as arguments
...
- **`args`** — List of arguments to pass to fn
...
**Parameters:**
- **`fn`** — Symbol or string naming the R function
- **`args`** — List of arguments to pass (default empty)
- **`envir`** — Environment to search for fn (default .GlobalEnv)
...
**Parameters:**
- **`name`** — Symbol or string naming the binding to look up
- **`envir`** — Environment to search in (default .GlobalEnv)
...
**Parameters:**
- **`name`** — Symbol or string naming the variable to remove
- **`envir`** — Environment to remove from (default current environment)
...
- **`parent`** — Parent environment for the child (default current environment)
...
**Parameters:**
- **`expr`** — Expression to macro-expand
...
**Parameters:**
- **`expr`** — Expression to recursively macro-expand
...
**Parameters:**
- **`expr`** — Expression to evaluate with warnings suppressed
...
**Parameters:**
- **`expr`** — Expression to evaluate with messages suppressed
...
**Parameters:**
- **`data`** — Data frame or list providing the evaluation context
- **`expr`** — Expression evaluated with data columns as variables
...
- **`expr`** — Expression that can assign new/modified columns
...
- **`condition`** — Row-selection expression evaluated in x's context
- **`rest`** — Optional additional arguments (e.g. select)
...
**Parameters:**
- **`args`** — Arguments (not used; always signals an error)
...
**Parameters:**
- **`args`** — Expression and environment for substitution
...
- **`msg`** — Error message if assertion fails (default "Assertion failed")
...
**Parameters:**
- **`value`** — Value expected to be truthy
...
**Parameters:**
- **`value`** — Value expected to be falsy
...
**Parameters:**
- **`expected`** — Expected value
- **`actual`** — Actual value to compare with identical?
...
**Parameters:**
- **`expr`** — Expression expected to signal an error
...
**Parameters:**
- **`expr`** — Expression expected to complete without error
