...
Arl can call any R function directly. Because Arl code is compiled to R code
before being execute, function names, operators, and data structures are shared
between Arl and R.
