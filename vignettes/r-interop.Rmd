...
1. Use Rye's `call` function to build unevaluated call expressions
...
This pattern is used throughout the stdlib - see `try*` in `control.rye` and
`assert-error` in `assert.rye` for working examples.
