...
if (has_bench_data) {
  ...
  components <- c("tokenizer", "parser", "macro", "eval")
  comp_labels <- c("Tokenizer", "Parser", "Macro Expander", "Compiler / Evaluator")
...
The compiler/evaluator and macro expander together dominate runtime.
...
```bash
# COMPONENT can be tokenizer, parser, macro, eval, stdlib, e2e
