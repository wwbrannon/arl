...
```{arl, include=FALSE}
(define __test-d (dict))
(dict-set __test-d "x" 42)
(assert-equal 42 (dict-get __test-d "x"))
```
...
```{arl, include=FALSE}
(define __test-dr (dict :x 1 :y 2))
(dict-remove __test-dr "x")
(assert-false (dict-has? __test-dr "x"))
```
...
```{arl, include=FALSE}
(define __test-ma (dict :x 1 :y 2))
(define __test-mb (dict :y 99 :z 3))
(define __test-mm (dict-merge __test-ma __test-mb))
(assert-equal 99 (dict-get __test-mm "y"))
(assert-equal 3 (dict-get __test-mm "z"))
```
