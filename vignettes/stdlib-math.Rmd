...
These functions are provided by the `math` module (`inst/arl/math.arl`).
...
**See also:** [rational?](#rational-p), [complex?](#complex-p), [number?](stdlib-types.html#number-p) (in `types` module)
...
**See also:** [real?](#real-p), [number?](stdlib-types.html#number-p) (in `types` module), [make-rectangular](#make-rectangular)
...
**See also:** [real?](#real-p), [integer?](#integer-p), [number?](stdlib-types.html#number-p) (in `types` module)
...
**See also:** [inexact?](#inexact-p), [exact->inexact](stdlib-conversions.html#exact-to-inexact) (in `conversions` module)
...
**See also:** [exact?](#exact-p), [inexact->exact](stdlib-conversions.html#inexact-to-exact) (in `conversions` module)
