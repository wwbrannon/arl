...
### __list-last {#__list-last}

Return last element of list.

**Signature:** `(__list-last lst)`

---

### __list-head {#__list-head}

Return list without last element.

**Signature:** `(__list-head lst)`
...
### __assoc-by-pred {#__assoc-by-pred}

Find first alist entry with matching key using given predicate.

**Signature:** `(__assoc-by-pred key alist pred)`
...
**See also:** [rassoc](#rassoc), [assoc-by-identical?](#assoc-by-identical), [assoc-by-==](#assoc-by-eq-eq)

---

### assoc-by-equal? {#assoc-by-equal}
...
### assoc-by-identical? {#assoc-by-identical}
...
**See also:** [assoc](#assoc), [assoc-by-identical?](#assoc-by-identical)
...
**See also:** [assoc](#assoc), [rassoc-by-equal?](#rassoc-by-equal)

---

### rassoc-by-equal? {#rassoc-by-equal}
...
Return sublist of lst starting at first element equal to x, or #f if not found. Uses equal? by default; pass :use-identical #t for R's identical().
...
**See also:** [length>](#length-gt), [length<](#length-lt), [empty?](stdlib-types.html#empty)
