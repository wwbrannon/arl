...
#> function (a, b) 
#> {
#>     .__coverage_track("/tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/logic.arl", 
#>         75L, 75L)
#>     if (.__true_p(a)) {
#>         .__coverage_track("/tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/logic.arl", 
#>             76L, 76L)
...
#> ======================================
#> 
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/assert.arl    0/  67 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/binding.arl    0/  76 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/control.arl    0/  91 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/conversions.arl    0/  90 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/core.arl    0/  79 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/dict.arl    0/ 220 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/display.arl    0/ 175 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/equality.arl    0/ 113 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/functional.arl    0/ 167 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/io.arl    0/ 129 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/list.arl    0/ 183 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/logic.arl    3/   7 lines ( 42.9%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/looping.arl    0/ 108 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/math.arl    0/  83 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/r-interop.arl    0/  54 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/sequences.arl    0/ 197 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/set.arl    0/ 162 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/sort.arl    0/  71 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/strings.arl    0/ 194 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/struct.arl    0/  33 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/threading.arl    0/  75 lines (  0.0%)
#> /tmp/RtmpN7azmG/temp_libpath1cd51f9f8ad6/arl/arl/types.arl    0/ 142 lines (  0.0%)
#> 
