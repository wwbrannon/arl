...
#' Find the current Rye evaluation environment by walking the call stack.
#'
#' Used when Rye code (e.g. stdlib or user code) needs to obtain the active
#' evaluation environment, e.g. for \code{r/eval} or \code{current-env}.
#'
#' @keywords internal
#' @noRd
rye_current_env <- function() {
  for (i in 0:20) {
