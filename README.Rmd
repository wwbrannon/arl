...
if stdlib loading is disabled): `eval`, `read`, `write`, `gensym`, `capture`,
...
For the complete function reference, see the [Standard Library Reference](articles/stdlib-reference.html).
