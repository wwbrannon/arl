...
Arl compiles to R and evaluates with R's own `eval()`, so every R function
and data structure is available with no bridging or FFI. On top of that, you
get Lisp's macro system for compile-time code transformation and self-tail-call
optimization for stack-safe recursion.
