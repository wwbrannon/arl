...
[![R Coverage](https://codecov.io/gh/wwbrannon/rye/branch/main/graph/badge.svg?flag=r-code)](https://codecov.io/gh/wwbrannon/rye?flags%5B0%5D=r-code)
[![Rye Coverage](https://codecov.io/gh/wwbrannon/rye/branch/main/graph/badge.svg?flag=rye-code)](https://codecov.io/gh/wwbrannon/rye?flags%5B0%5D=rye-code)
...
Rye's compiler implements **self-tail-call optimization** (self-TCO). When
...
Additional Rye stdlib modules live in `inst/rye` so you can import just what you need:
...
4. **Compiler**: Compiles Rye AST to R code, handling all special forms and self-TCO
