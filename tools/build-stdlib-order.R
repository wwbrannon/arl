# Generate inst/rye/load-order.txt from inst/rye/*.rye (run from package root; make build/install depend on this).
...
writeLines(d$get_load_order(), "inst/rye/load-order.txt")
